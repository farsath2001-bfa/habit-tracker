...
import { Eye, EyeOff, LogIn, Flame, BarChart3, CalendarCheck2, Info, Mail, Lock, Sparkles, ShieldCheck, CreditCard } from 'lucide-react';
...
export default function Login() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50 dark:bg-slate-950">
      ...
      <div className="relative flex w-full flex-1 items-center justify-center overflow-y-auto px-4 py-6">
        ...
        <div className="fade-in relative w-full max-w-sm rounded-2xl border border-slate-200/70 bg-white/80 p-6 shadow-xl shadow-slate-200/60 backdrop-blur-sm dark:border-slate-800/70 dark:bg-slate-900/60 dark:shadow-none sm:p-8">
          ...
          <div className="mt-4 flex items-center justify-center gap-1.5 rounded-lg bg-slate-100 px-3 py-2 text-xs text-slate-500 dark:bg-slate-800/60 dark:text-slate-400 lg:justify-start">
            <Info size={13} className="shrink-0" />
            <span>
              Demo login: <span className="font-medium text-slate-600 dark:text-slate-300">demo@example.com</span> / Demo1234
            </span>
          </div>
        </div>
      </div>
